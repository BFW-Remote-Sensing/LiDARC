...
METADATA_QUEUE = rabbitConfig.queue_metadata_result
COMPARISON_QUEUE = rabbitConfig.queue_comparison_result
PREPROCESSING_QUEUE = rabbitConfig.queue_preprocessing_result

METADATA_RK = rabbitConfig.routing_metadata_result
COMPARISON_RK = rabbitConfig.routing_comparison_result
PREPROCESSING_RK = rabbitConfig.routing_preprocessing_result
